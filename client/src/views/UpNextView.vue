...
import AddBooksToQueueSheet from '@/features/reading-queue/components/AddBooksToQueueSheet.vue'
...
<template>
    ...
    <div class="flex flex-col gap-4 py-4 sm:py-6 max-w-5xl w-full">
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
          <button
            class="flex items-center gap-1.5 h-8 px-3 rounded-md border border-input bg-background text-sm hover:bg-muted transition-colors"
  ...
  <AddBooksToQueueSheet :open="addSheetOpen" @update:open="onSheetClose" />
</template>
