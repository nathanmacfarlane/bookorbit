...
const DEFAULT_APP_SETTINGS: Array<typeof schema.appSettings.$inferInsert> = [
  ...
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FETCH_METADATA, value: 'true' },
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FINALIZE_ENABLED, value: 'false' },
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FINALIZE_THRESHOLD, value: '85' },
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FINALIZE_LIBRARY_ID, value: '' },
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FINALIZE_FOLDER_ID, value: '' },
  { key: APP_SETTING_KEYS.BOOK_BUCKET_AUTO_FINALIZE_METADATA_MODE, value: 'safe_merge' },
