...
import { appConfig, authConfig, dbConfig, emailConfig, fileWriteConfig, storageConfig } from './config/config';
...
@Module({
  imports: [
    ...
    ConfigModule.forRoot({
      ...
      load: [appConfig, dbConfig, authConfig, storageConfig, fileWriteConfig, emailConfig],
    }),
